...
# Matlab Fix
#alias matlab='wmname LG3D & matlab -c ~/license.dat'
...
# echo
#echo -ne "${CYAN}"; uptime
echo -e "${GREEN}"; /usr/games/fortune #; echo ""
#echo -e "${LIGHTYELLOW}";echo "" `ddate`; echo ""
#echo -ne "${LIGHTBLUE}  May the Schwartz be with you $USER"
#echo
#echo
